...
UINT32 OV5646AF_MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(OV5645AF_MIPI_YUV)
    {OV5645AFMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5645AF_MIPI_YUV, OV5645AF_MIPI_YUV_SensorInit}, 
#endif
#if defined(OV5646AF_MIPI_YUV)
    {OV5646AFMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5646AF_MIPI_YUV, OV5646AF_MIPI_YUV_SensorInit}, 
#endif
